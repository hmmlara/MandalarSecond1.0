    ...
    <section id="products" class="">
        <div class="container-xxl">
            <div class="row">
                <div class="col-md-4 mb-4">
                    <div class="card">
                        <img src="image/products/product-image.jfif" class="card-img-top product-image"
                            alt="Product 1" />
                        <div class="card-body">
                            <h5 class="card-title">Product 1</h5>
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="d-flex align-items-center">
                                    <img src="image/profiles/Profile.png" class="rounded-circle profile-on-card"
                                        alt="Seller 1" />
                ...
                <div class="col-md-4 mb-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="d-flex align-items-center">
                                    <img src="image/user-profile/99b847b47e05626961b6ae115feca94c.jpg"
                ...
                <div class="col-md-4 mb-4">
                    <div class="card">
                        <img src="image/products/product-image3.jfif" class="card-img-top product-image"
                            alt="Product 3" />
                        <div class="card-body">
