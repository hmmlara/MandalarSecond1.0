                ...
                <div class="signup-form">
                    ...
                    <form method="POST" class="register-form " id="register-form"  enctype="multipart/form-data">
                        ...
                        <div class="form-group mt-5">
                            ...
                            <input type="text" name="fname" id="fname"  placeholder="First Name" value="<?php if(isset($fname)) echo $fname ?>"/>
                        </div>
                        <div class="form-group ">
                            <label for="name"><i class="fa-solid fa-user"></i></label>
                            <input type="text" name="lname" id="lname" placeholder="Last Name" value="<?php if(isset($lname)) echo $lname ?>"/>
                        </div>
                        <div class="form-group">
                            <label for="email"><i class="fa-solid fa-envelope"></i></label>
                            <input type="email" name="email" id="email" placeholder="Your Email" value="<?php if(isset($email)) echo $email ?>"/>
                        </div>
                        <div class="form-group">
                        ...
                        <span class="text-danger"><?php if(isset($exitsAcc)) echo $exitsAcc; ?></span>
                        <div class="form-group">
                        ...
                        <div class="form-group form-button">
                            <button type="submit" name="register" id="signup" class="btn btn-primary" value="Register">Register</button>
                            <!-- <input type="submit"  /> -->
                        </div>
                    </form>
                </div>
