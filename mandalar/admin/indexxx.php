				...
				<div class="col-xl-6 col-xxl-7">
					<div class="card flex-fill w-100">
						<div class="card-header">
							...
							<h5 class="card-title mb-0">Post In Each Day</h5>
						</div>
				...
				<div class="col-12 col-md-6 col-xxl-3 d-flex order-2 order-xxl-3">
					<div class="card flex-fill w-100">
						<div class="card-header">
							...
							<h5 class="card-title mb-0">sold out product in each category</h5>
						</div>
				...
				<div class="col-12 col-md-12 col-xxl-6 d-flex order-3 order-xxl-2">
					<div class="card flex-fill w-100">
						...
						<div class="card-body px-4">
							...
							<div class="chart">
								<canvas style="height:400px" id="SubChart2"></canvas>
				...
				<div class="col-12 col-md-6 col-xxl-3 d-flex order-1 order-xxl-1">
					<div class="card flex-fill">
						<div class="card-header">
							...
							<h5 class="card-title mb-0">Posts in Each Category</h5>
						</div>
						<div class="card-body d-flex">
							<div class="align-self-center w-100">
								<div class="chart">
				...
				<div class="col-12 col-lg-8 col-xxl-9 d-flex">
					<div class="card flex-fill">
						<div class="card-header">
							...
							<h5 class="card-title mb-0">Sold Out Product on each day</h5>
						</div>
				...
				<div class="col-12 col-lg-4 col-xxl-3 d-flex">
					<div class="card flex-fill w-100">
						<div class="card-header">
							...
							<h5 class="card-title mb-0">Total Sales in Each Sub Category</h5>
						</div>
